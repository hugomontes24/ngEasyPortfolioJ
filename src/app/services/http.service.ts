...
import { Portfolio } from "../portfolio/model/skill";
...
export class HttpService {
    ...
    getById( table: string, userId: number, id: number){
        ...
        return this.http.get<Portfolio>(`http://localhost/angular/ngEasyPortfolio/src/app/services/api/${table}.php?action=readById&id=${userId}&p_id=${id}`, {headers:headers, responseType: "json"});
    }
